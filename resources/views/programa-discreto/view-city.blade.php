...
@section('pageContent')
    ...
    <div class="row">
        <div class="col-md-7">
            <a href="#">
                <img class="img-responsive" src="/image/700x300/luana1.jpg" alt="" width="700" height="300">
            </a>
        </div>
        <div class="col-md-5">
            <h3>Luana</h3>
            ...
            <a class="btn btn-primary" href="#">Ligue agora <span class="glyphicon glyphicon-chevron-right"></span></a>
        </div>
    </div>
    <!-- /.row -->
