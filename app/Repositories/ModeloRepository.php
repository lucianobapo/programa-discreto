    ...
    public function __construct()
    {
        $this->modelos = [
            ...
            'mirela'=>[
                ...
                'idade' => '24 anos',
                'descricao' => 'Melhor do que nunca!!!Sempre buscando inovar e satisfazer meus clientes, resolvi fazer esse ensaio caseiro. Mostrando minhas curvas exatamente como ele é, 100% natural sem nenhuma intervenção cirurgica. Sou uma mulher para homens de bom gosto. Discrição, educação e um bom sexo são o meu forte!!',
                'gostoDeFazer' => [
                    'Sexo Vaginal',
                    'Fantasias',
                    'Homens',
                ...
                'foto_capa' => 0,
                'foto_home' => '/image/700x300/mirela1.jpg',
                'foto1' => '/image/750x500/mirela1.jpg',
                'foto2' => '/image/750x500/mirela2.jpg',
                'foto3' => '/image/750x500/mirela3.jpg',
                'foto4' => '/image/750x500/mirela4.jpg',
                'foto1Thumb' => '/image/500x300/mirela1.jpg',
                'foto2Thumb' => '/image/500x300/mirela2.jpg',
                'foto3Thumb' => '/image/500x300/mirela3.jpg',
                'foto4Thumb' => '/image/500x300/mirela4.jpg',
            ],
            'luana'=>[
                'nome' => 'Luana',
                'cidade' => 'Itaperuna - RJ',
